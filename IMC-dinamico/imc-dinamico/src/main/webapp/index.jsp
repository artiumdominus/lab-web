...
<body>
    ...
    <div class="container">
        <table class="table table-dark table-striped">
            ...
            <tbody>
                <tr <%=(imc != null && imc < 17 ? "class=\"table-primary text-body\"" : "")%>>
                    <td>Abaixo de 17</td>
                    <td>Muito abaixo do peso</td>
                </tr>
                <tr <%=(imc != null && imc >= 17 && imc < 18.5 ? "class=\"table-primary text-body\"" : "")%>>
                    <td>Entre 17 e 18,49</td>
                    <td>Abaixo do peso</td>
                </tr>
                <tr <%=(imc != null && imc >= 18.5 && imc < 25 ? "class=\"table-primary text-body\"" : "")%>>
                    <td>Entre 18,5 e 24,99</td>
                    <td>Peso normal</td>
                </tr>
                <tr <%=(imc != null && imc >= 25 && imc < 30? "class=\"table-primary text-body\"" : "")%>>
                    <td>Entre 25 e 29,99</td>
                    <td>Acima do peso</td>
                </tr>
                <tr <%=(imc != null && imc >= 30 && imc < 35 ? "class=\"table-primary text-body\"" : "")%>>
                    <td>Entre 30 e 34,99</td>
                    <td>Obesidade I</td>
                </tr>
                <tr <%=(imc != null && imc >= 35 && imc < 40 ? "class=\"table-primary text-body\"" : "")%>>
                    <td>Entre 35 e 39,99</td>
                    <td>Obesidade II (severa)</td>
                </tr>
                <tr <%=(imc != null && imc > 40 ? "class=\"table-primary text-body\"" : "")%>>
                    <td>Acima de 40</td>
